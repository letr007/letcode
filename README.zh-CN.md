...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/changelog-0.13.0-informational?style=flat-square" alt="Changelog"></a>
...
# Anthropic 路由可配置，例如：
# anthropic_thinking = { mode = "adaptive" } # 配置 reasoning_effort 时必须为 adaptive
