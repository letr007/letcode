...
tool_result_images = {supports_images}
...
#[test]
fn image_usage_matches_cold_warm_and_provider_anchored_projections() {
    for supports_images in [false, true] {
        ...
        agent.set_model_catalog(HashMap::from([(
            ...
            ModelRequestMetadata {
                ...
                supports_tools: true,
                supports_input_images: supports_images,
                supports_tool_result_images: supports_images,
                ..Default::default()
            },
        )]));
